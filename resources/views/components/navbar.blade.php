            ...
            <div class="flex items-center lg:space-x-2">
                ...
                <div id="dropdownCart"
                    ...
                    <ul class="p-2 space-y-2 text-sm text-gray-900 dark:text-white">
                        ...
                        <li>
                            <a href="#"
                                class="flex items-center p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-600">
                                Product 1 <span class="ml-auto text-gray-500">2 x $20</span>
                            </a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-600">
                                Product 2 <span class="ml-auto text-gray-500">1 x $10</span>
                            </a>
                        </li>
                    </ul>
                    <div class="p-2">
                        <a href="#"
                            class="block w-full text-center text-white bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-md">Proceed
                            to Checkout</a>
                    </div>
                </div>
